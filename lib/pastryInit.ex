...
use GenServer
  ...
  #  populated_map = PastryInitFunctions.update_routing_table(routing_table, newNode, global_reg_to_list -- [newNode])
  ...
  #  {leafSet, routingTable} = currentState
  ...
  #  currentState = {modified_curr_node_leafset, routingTable}
